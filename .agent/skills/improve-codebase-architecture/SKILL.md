...
description: "Find deepening opportunities in a codebase — refactors that turn shallow modules into deep ones, improving testability and AI-navigability. Use when user wants to improve architecture, find refactoring opportunities, consolidate tightly-coupled modules, or make a codebase more maintainable."
---
...
- If `systematic-debugging` discovers an architectural deficiency during a fix, it should recommend this skill after the fix is in.
- If you need to understand the broader context first, use `zoom-out` before this skill.
- If you want to break the improvement plan into executable tasks, follow up with `writing-plans`.
- Recommend running this skill **once every few days** to prevent tech debt accumulation.
